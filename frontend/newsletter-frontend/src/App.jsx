...
//             }}
//           >
//             <h3 style={{ margin: '0 0 10px 0', textAlign: 'center' }}>Transform Text with AI</h3>
//             <select
//               value={tone}
...
//             {tone === 'Custom Tone' && (
//               <>
//                 <label htmlFor="customPrompt" style={{fontSize: '0.9rem', color: '#333'}}>Describe how to transform:</label>
//                 <textarea
//                   id="customPrompt"
//                   rows={4}
//                   value={customPrompt}
//                   onChange={e => setCustomPrompt(e.target.value)}
//                   style={{ padding: '10px', fontSize: '1rem', resize: 'vertical', borderRadius: '4px', border: '1px solid #ccc' }}
//                   placeholder="e.g., Make it more concise and witty"
//                 />
//               </>
//             )}
...
//               <button 
//                 onClick={closeModal} 
//                 style={{ padding: '8px 15px', borderRadius: '4px', border: '1px solid #ccc', cursor: 'pointer' }}
//               >
//                 Cancel
//               </button>
//               <button
...
//                 disabled={loadingAI}
//                 style={{
//                   padding: '8px 15px', backgroundColor: loadingAI ? '#ccc' : '#5cb85c',
//                   border: 'none', color: 'white', cursor: loadingAI ? 'not-allowed' : 'pointer',
//                   borderRadius: '4px',
//                 }}
//               >
//                 {loadingAI ? 'Generating...' : 'Transform'}
//               </button>
//             </div>
//           </div>
//         </div>
...
//             }}
//           >
//             <h3 style={{ margin: '0 0 10px 0', textAlign: 'center' }}>Generate Image with AI</h3>
//             <textarea
//               rows={4}
//               value={imagePrompt}
